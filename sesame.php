...
<html lang="en">
<head>
<title>Sesame Seeds Category</title>
<meta charset="utf-8">
...
<div class="super_container">
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/sesame_background.jpg"></div>
		<div class="home_overlay"></div>
		<div class="home_content d-flex flex-column align-items-center justify-content-center">
			<h2 class="home_title">Sesame Seeds</h2>
		</div>
	</div>
					...
					<div class="shop_sidebar">
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
								...
								<li><a href="sesame.php">Sesame Seeds</a></li>
								<li><a href="garlic.php">Garlic</a></li>
								<li><a href="cashew.php">Cashew Nuts</a></li>
