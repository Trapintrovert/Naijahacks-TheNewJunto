...
<html lang="en">
<head>
<title>Yam Tuber Category</title>
<meta charset="utf-8">
...
<div class="super_container">
						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="cat_menu_container">
								...
								<ul class="cat_menu">
									...
									<li><a href="sesame.php">Sesame Seed<i class="fas fa-chevron-right"></i></a></li>
									<li><a href="rubber.php">Rubber<i class="fas fa-chevron-right"></i></a></li>
									<li><a href="schrimps.php">Shrimps<i class="fas fa-chevron-right"></i></a></li>
									<li><a href="garlic.php">Garlic<i class="fas fa-chevron-right"></i></a></li>
									<li><a href="cashew.php">Cashew Nuts<i class="fas fa-chevron-right"></i></a></li>
									<li><a href="charcoal.php">Charcoal<i class="fas fa-chevron-right"></i></a></li>
									<li class="hassubs">
										<a href="#">More<i class="fas fa-chevron-right"></i></a>
										<ul>
											<li><a href="yamtuber.php">Yam Tubers<i class="fas fa-chevron-right"></i></a></li>
										</ul>
									</li>
								</ul>
							</div>
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/yamtuber_background.jpg"></div>
		<div class="home_overlay"></div>
		<div class="home_content d-flex flex-column align-items-center justify-content-center">
			<h2 class="home_title">Yam Tuber</h2>
		</div>
	</div>
					...
					<div class="shop_sidebar">
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
								<li><a href="ginger_cat.php">Ginger</a></li>
								<li><a href="cocoa_cat.php">Cocoa</a></li>
								<li><a href="sesame_cat.php">Sesame Seeds</a></li>
								<li><a href="garlic_cat.php">Garlic</a></li>
								<li><a href="cashew_cat.php">Cashew Nuts</a></li>
								<li><a href="rubber_cat.php">Rubber</a></li>
					...
					<div class="shop_content">
						...
						<a href="#" tabindex="0">
							<div class="product_item is_new">
								...
								<div class="product_content">
									...
									<div class="product_name"><div>Philips BT6900A</div></div>
								</div>
							</div>
						</a>
						...
						<a href="#" tabindex="0">
							<div class="product_item discount">
								...
								<div class="product_content">
									<div class="product_price">$225</div>
									<div class="product_name"><div>Huawei MediaPad..</div></div>
								</div>
							</div>
						</a>
							<!-- Product Item -->
