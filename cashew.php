...
<html lang="en">
<head>
<title>Cashew Nut Category</title>
<meta charset="utf-8">
...
<div class="super_container">
						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="cat_menu_container">
								...
								<ul class="cat_menu">
									...
									<li><a href="charcoal">Charcoal<i class="fas fa-chevron-right"></i></a></li>
									<li class="hassubs">
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/cashew_background.jpg"></div>
		<div class="home_overlay"></div>
		<div class="home_content d-flex flex-column align-items-center justify-content-center">
			<h2 class="home_title">Cashew Nuts</h2>
		</div>
	</div>
