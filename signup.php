			...
			<div class="signup-block">
				<form method="POST">
					...
					<div class="form-group">
						...
						<input type="password" name="cpassword" class="lock" placeholder="Enter Confirm Password" required="">
					</div>
					...
					<div class="form-group">
						...
						<input type="text" name="state" class="lock" placeholder="Enter State" required="">
					</div>
					...
					<div class="form-group">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="gender" value="supplier"> Supplier
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="gender" value="buyer"> Buyer
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="gender" value="buyer"> Both
					</div>
					<div class="form-group">
